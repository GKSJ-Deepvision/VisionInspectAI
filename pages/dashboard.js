...
export default function Dashboard() {
  ...
  function handleResult(fileName, result) {
  ...
  if (!role) return null; // avoid flashing wrong view before role loads
      ...
      <main className="max-w-6xl mx-auto px-6 py-8 space-y-6">
        {isSupervisor ? (
          ...
          <>
            ...
            <div>
              <h2 className="font-display text-lg text-ink mb-3">Latest Result</h2>
              <ResultCards result={latestResult} />
            </div>
